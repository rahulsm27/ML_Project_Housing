#Read from Config yaml and housing -> entity-> configentity
import sys
from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTrasformationConfig,\
...
class Configuration:
    ...
    def get_data_trasnformation_config(self) -> DataTrasformationConfig:
        pass

    def get_model_trainer_config(self)-> ModelTrainerConfig:
        pass

    def get_model_evalaution_config(self)-> ModelEvaluationConfig:
        pass
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig:
        try:
            ...
            artifact_dir = os.path.join(ROOT_DIR, 
                                        ...
                                        training_pipleline_config[TRAINING_PIPELINE_ARTIFACT_DIR_KEY])
            training_pipleline_config = TrainingPipelineConfig(artifact_dir=artifact_dir)
            logging.info(f"Training pipeline config : {training_pipleline_config}")
