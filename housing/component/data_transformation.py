...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logging.info(f"{'='*20} Starging DATA TRANSFORMAITON {'='*20}")    
            ...
            logging.info(f"Applying preprocessing object on training and testing df.")
            ...
            logging.info(f"Saving transformed trainign and testing array.")
